(function() {
    var h = {},
        mt = {},
        c = {
            id: "f1ba5b4a33d29d84db69f029b9ace483",
            dm: ["hubwiz.com"],
    ...
    var p = !0,
        ...
        r = !1;
    mt.j = {};
    mt.j.Ia = /msie (\d+\.\d+)/i.test(navigator.userAgent);
    ...
    mt.j.ra = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    mt.j.colorDepth = window.screen.colorDepth || 0;
    mt.cookie = {};
    mt.cookie.set = function(a, b, e) {
        var d;
        e.F && (d = new Date, d.setTime(d.getTime() + e.F));
        document.cookie = a + "=" + b + (e.domain ? "; domain=" + e.domain : "") + (e.path ? "; path=" + e.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (e.Ma ? "; secure" : "")
    };
                        ...
                        for (f = 0; f < l; f++)
                            switch (k = d[f], typeof k) {
                                ...
                                case "unknown":
                                    break;
                                default:
                                    n && e.push(","), e.push(mt.i.stringify(k)), n = 1
                            }
                        e.push("]");
                        return e.join("")
                    }
    ...
    h.m = {
        Ha: "http://tongji.baidu.com/hm-web/welcome/ico",
            ...
            c.rec && a.T(function() {
                for (var g = 0, l = c.rp.length; g < l; g++) {
                    ...
                    if (f && !(2 == f && !k || k && "" !== k.innerHTML))
                        k = "", k = Math.round(Math.random() * b.A), k = 4 == f ? "http://crs.baidu.com/hl.js?" + ["siteId=" + c.id, "planId=" + n, "rnd=" + k].join("&") : "http://crs.baidu.com/t.js?" + ["siteId=" + c.id, "planId=" + n, "from=" + d(), "referer=" + encodeURIComponent(document.referrer), "title=" + encodeURIComponent(document.title), "rnd=" +
                            k
                        ].join("&"), e(k)
                }
            })
    ...
    (function() {
        ...
        h.q.c("pv-b", function() {
            if (c.trust && c.vcard) {
                var d = a.protocol + "//trust.baidu.com/vcard/v.js?" + ["siteid=" + c.vcard, "url=" + encodeURIComponent(document.location.href), "source=" + e(), "rnd=" + Math.round(Math.random() * a.A)].join("&");
                b(d)
            }
        })
    })();
                    ...
                    if (!(4 > a.length)) {
                        ...
                        if (0 < d && 6 > d && 0 < e && 4 > e) {
                            ...
                            a = h.b.a.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g,
                                "");
                            "" !== a ? h.b.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age) : h.b.qa("Hm_cv_" + c.id)
                        }
                    }
                },
                _setReferrerOverride: function(a) {
                    1 < a.length && (h.b.a.su = a[1].charAt && "/" == a[1].charAt(0) ? g.protocol + "//" + window.location.host + a[1] : a[1], f.Q = p)
                },
                ...
                _trackRTEvent: function(b) {
                    ...
                    if (e.e(b, "Object")) {
                        ...
                        if (900 >= l)
                            ...
                            for (var l = Math.ceil(l / 900), t = "block|" + Math.round(Math.random() * g.A).toString(16) + "|" + l + "|", s = [], u = 0; u < l; u++)
        ...
        a.prototype = {
            ...
            N: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.R(document.location.href, d))
                        return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },
            ha: function() {
                if (!document.referrer)
                    return m.k - m.o > c.vdur ? 1 : 4;
                var a =
                    r;
                this.w(document.referrer) && this.w(document.location.href) ? a = p : (a = b.O(document.referrer), a = this.I(a || "", document.location.hostname));
            ...
            va: function() {
                ...
                if (0 === c.nv && this.w(document.location.href) &&
                    ("" === document.referrer || this.w(document.referrer)))
                    a = 0, b = 4;
                this.a.nv = a;
                this.a.st = b;
                this.a.cc = d;
            ...
            ua: function() {
                for (var a = [], b = 0, d = m.V.length; b < d; b++) {
                    var e = m.V[b],
                        f = this.a[e];
            ...
            wa: function() {
                ...
                this.a.cm = b.h(a, m.ma) || "";
                this.a.cp = b.h(a, m.na) || "";
                this.a.cw = b.h(a, m.la) || "";
                this.a.ci = b.h(a, m.ka) || "";
                this.a.cf = b.h(a, m.oa) || ""
            },
            init: function() {
                try {
                    this.wa(), 0 === this.a.nv ? this.ta() : this.K(".*"), h.b = this, this.Z(),
                        v.s("pv-b"), this.sa()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
            ...
            sa: function() {
                ...
                "undefined" === typeof window._bdhm_autoPageview || window._bdhm_autoPageview === p ? (this.H = p, this.a.et = 0, this.a.ep = "", this.g(a)) : a()
            },
            g: function(a) {
                var b = this;
            ...
            Z: function() {
                var a = document.location.hash.substring(1),
                    d = RegExp(c.id),
                    e = -1 < document.referrer.indexOf(m.X) ? p : r,
                    f = b.h(a, "jn"),
        ...
        if (c.comm && "undefined" !== typeof h.b) {
            ...
            b.c(document, "click", function(b) {
                ...
                for (n(l, function(b, e) {
                    ...
                    }); k && k !== document && n(d, v) !== r;) k = k.parentNode
            })
        }
    })();
    (function() {
